...
## How it works
1. We give each affiliate a unique referral link, e.g. `https://marketmob.com/go/yourapp-JOHN50`
2. When someone clicks it, they land on YOUR website with `?promo=JOHN50&ref=marketmob` appended to the URL.
...
```
POST https://marketmob.com/api/track/signup
...
```
POST https://marketmob.com/api/track/conversion
Content-Type: application/json
